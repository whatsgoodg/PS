...
이 원리를 이용하여 Flood Fill(예를 들어, 외부 윤곽선 안에 있는 모든 영역을 하나의 색으로 덮어쓰는 알고리즘이다)을 BFS로 구현할 수 있다.      
 <img src="[https://github.com/whatsgoodg/Codes_for_tests/blob/main/images/LIST.JPG?raw=true](https://github.com/whatsgoodg/Codes_for_tests/blob/main/BFS/images/fish.png?raw=true)"  width="500" height="200"/>     
